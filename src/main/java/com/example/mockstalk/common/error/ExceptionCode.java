...
public enum ExceptionCode implements ErrorCode {
    ...
    NOT_READY_STOCK(HttpStatus.BAD_REQUEST, "주식이 아직 업로드 되지 않았습니다."),
    ...
    NOT_FOUND_PRICE(HttpStatus.NOT_FOUND, "Redis에 해당 종목의 가격 정보가 없습니다."),
    NOT_FOUND_DATA(HttpStatus.NOT_FOUND, "해당 데이터가 없습니다."),
